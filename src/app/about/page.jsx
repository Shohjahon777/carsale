...
export default function AboutPage() {
    ...
    return (
        <div className="relative overflow-hidden page-scrollable">
            {/* Фоновые градиенты */}
            <div
                className="absolute inset-0 bg-gradient-to-br from-primary-light/10 via-white to-accent/10 dark:from-primary-dark/20 dark:via-black dark:to-primary-dark/5"></div>
            <div
                className="absolute top-20 right-[10%] w-64 h-64 bg-primary/20 dark:bg-primary/10 rounded-full blur-3xl opacity-70"></div>
            <div
                className="absolute bottom-20 left-[5%] w-72 h-72 bg-accent/20 dark:bg-primary-dark/10 rounded-full blur-3xl opacity-70"></div>
            ...
            <section className="py-16 px-4 bg-gray-50 dark:bg-gray-900/50 relative overflow-hidden">
                <div className="container mx-auto">
                    ...
                    <div className="relative max-w-4xl mx-auto mb-20">
                        <div
                            className="absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-primary/20 dark:bg-primary/30"></div>
                            ...
                            >
                                ...
                                <div className={`w-1/2 ${index % 2 === 0 ? 'pr-16 text-right' : 'pl-16'}`}>
                                    <div
                                        ...
                                        <span
                                            className="text-primary dark:text-primary-light text-lg font-bold">{item.year}</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                        {t.history.values.items.map((value, index) => (
                            ...
                            >
                                <div
                                    className="w-14 h-14 flex items-center justify-center text-2xl mb-4 bg-primary/10 dark:bg-primary/20 rounded-full">
                                    {value.icon}
                                </div>
                ...
                <div className="container mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {t.expertise.areas.map((area, index) => (
                            ...
                            >
                                <div
                                    className="w-16 h-16 flex items-center justify-center text-2xl bg-primary/10 dark:bg-primary/20 rounded-2xl mb-4">
                                    {area.icon}
                                </div>
                                ...
                                <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700">
                                    ...
                                    <div className="flex justify-between items-center mt-2">
                                        <span
                                            className="text-sm text-gray-500 dark:text-gray-400">Уровень экспертизы</span>
                                        <span
                                            className="text-sm font-medium text-primary dark:text-primary-light">{75 + index * 5}%</span>
                                    </div>
                                </div>
                            </motion.div>
                        ))}
                        ...
                        {t.team.leadership.members.map((member, index) => (
                            ...
                            >
                                <div className="relative aspect-square">
                                    ...
                                    />
                                    <div
                                        className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 hover:opacity-100 transition-opacity flex items-end">
                    ...
                    >
                        <div className="flex flex-col md:flex-row items-center justify-between">
                            <div className="mb-6 md:mb-0">
                                ...
                                <p className="opacity-90">Мы всегда ищем талантливых специалистов для развития нашей
                                    платформы</p>
                            </div>
                            <motion.button
            ...
            <section className="py-16 px-4 bg-gray-50 dark:bg-gray-900/50 relative overflow-hidden">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
                        {t.stats.items.map((stat, index) => (
                            ...
                            >
                                ...
                                <div
                                    className="absolute -right-10 -top-10 w-40 h-40 bg-gradient-to-br from-primary/10 to-accent/5 dark:from-primary/20 dark:to-primary-dark/10 rounded-full transition-all duration-500 group-hover:scale-110"></div>

                                <div className="relative">
                                    <div className="flex items-baseline">
                    <span
                        className="text-4xl sm:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary-dark dark:from-primary-light dark:to-primary">
                      <AnimatedCounter value={stat.value} suffix={stat.suffix}/>
                                    ...
                                    <div className="mt-2">
                                        ...
                                        {/* Индикатор прогресса */}
                                        <div
                                            className="h-1 w-full bg-gray-100 dark:bg-gray-700 rounded-full mt-4 overflow-hidden">
                                            <motion.div
                                                className="h-full bg-gradient-to-r from-primary to-primary-light"
                                                initial={{width: 0}}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            >
                                <div className="absolute inset-0 p-5">
                                    <div
                                        className="w-full h-full rounded-lg bg-gray-50 dark:bg-gray-800 overflow-hidden">
                                        {/* Заголовок визуализации */}
                                        <div
                                            className="absolute top-0 left-0 right-0 bg-gradient-to-r from-primary/10 to-primary-light/10 dark:from-primary/20 dark:to-primary-light/20 p-3 border-b border-gray-200 dark:border-gray-700 z-10">
                                                ...
                                                {t.stats.geography.countries.map((country, index) => {
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            <div
                                                                className="flex items-center mb-3 pb-2 border-b border-gray-100 dark:border-gray-600">
                                                                <div className="w-5 h-5 rounded-full mr-2"
                                                                     style={{backgroundColor: country.color}}></div>
                                                                <h5 className="text-sm font-bold text-gray-800 dark:text-white">{country.name}</h5>
                                                                <div
                                                                    className="ml-auto px-2 py-0.5 bg-primary/10 dark:bg-primary/20 rounded text-xs font-medium text-primary dark:text-primary-light">
                                                            ...
                                                            <div className="flex-1 flex flex-col justify-between">
                                                                <div className="space-y-2">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            className="text-gray-600 dark:text-gray-300">Рост продаж:</span>
                                                                        <span
                                                                            className="font-medium text-green-600 dark:text-green-400">+{salesGrowth}%</span>
                                                                    </div>
                                                                    ...
                                                                    <div
                                                                        className="flex items-center justify-between text-xs">
                                                                        <span
                                                                            className="text-gray-600 dark:text-gray-300">Средняя сделка:</span>
                                                                        <span
                                                                            className="font-medium text-gray-800 dark:text-gray-200">${avgDealValue.toLocaleString()}</span>
                                                                    </div>
                                                                    ...
                                                                    <div
                                                                        className="flex items-center justify-between text-xs">
                                                                        <span
                                                                            className="text-gray-600 dark:text-gray-300">Удовлетворенность:</span>
                                                                        <div className="flex items-center">
                                                                            <span
                                                                                className="font-medium text-amber-500">{satisfaction}%</span>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            className="text-gray-600 dark:text-gray-300">Доля рынка:</span>
                                                                        <span
                                                                            className="font-medium text-blue-600 dark:text-blue-400">{marketShare}%</span>
                                                                    </div>

                                                                    {/* Прогресс-бар доли рынка */}
                                                                    <div
                                                                        className="w-full h-1.5 bg-gray-100 dark:bg-gray-600 rounded-full overflow-hidden">
                                                                        <motion.div
                                                                            className="h-full"
                            ...
                            >
                                <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-6 flex items-center">
                                    <svg className="w-5 h-5 mr-2 text-primary dark:text-primary-light"
                                            ...
                                            <div className="flex justify-between items-center mb-1">
                                                <div className="flex items-center">
                                                    <div className="w-3 h-3 rounded-full mr-2"
                                                         style={{backgroundColor: country.color}}></div>
                                                    <span
                                                        className="text-gray-700 dark:text-gray-300 font-medium">{country.name}</span>
                                                </div>
                                                <div className="flex items-baseline">
                <span className="text-lg font-bold text-primary dark:text-primary-light mr-1">
                  {country.dealers}
                                                    ...
                                                    <span
                                                        className="text-xs text-gray-500 dark:text-gray-400">дилеров</span>
                                                </div>
                                            </div>

                                            <div
                                                className="w-full h-3 bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden shadow-inner">
                                                <motion.div
                                                ...
                                                >
                                                    <div
                                                        className="h-full w-full bg-white/20 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                                                </motion.div>
                                            </div>
                ...
                {index === 0 && (
                    <span
                        className="inline-flex items-center text-xs px-1.5 py-0.5 bg-primary/10 dark:bg-primary/20 text-primary dark:text-primary-light rounded">
                                ...
                                >
                                    ...
                                    <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
                                        <li className="flex items-start">
                                            <svg className="w-4 h-4 text-green-500 mt-0.5 mr-1.5 flex-shrink-0"
              ...
              <strong>{t.stats.geography.countries[0].name}</strong> лидирует с {t.stats.geography.countries[0].dealers} дилерами (
                                        ...
                                        <li className="flex items-start">
                                            <svg className="w-4 h-4 text-blue-500 mt-0.5 mr-1.5 flex-shrink-0"
                                                 fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                                                      d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/>
                                            </svg>
              ...
              Наибольший потенциал роста в {t.stats.geography.countries[t.stats.geography.countries.length - 2].name} и {t.stats.geography.countries[t.stats.geography.countries.length - 1].name}
                                        ...
                                        <li className="flex items-start">
                                            <svg className="w-4 h-4 text-amber-500 mt-0.5 mr-1.5 flex-shrink-0"
                                                 fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
