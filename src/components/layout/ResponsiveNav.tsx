  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 shadow-lg z-10">
      <div className="flex justify-between items-center px-4 py-3">
        ...
        <Link 
          href="/catalog"
          className={`flex flex-col items-center ${pathname.startsWith('/catalog') ? 'text-blue-500' : 'text-gray-500'}`}
        >
          <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <Link 
          href="/cart"
          className={`flex flex-col items-center ${pathname.startsWith('/cart') ? 'text-blue-500' : 'text-gray-500'}`}
        >
          <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <Link 
          href="/profile"
          className={`flex flex-col items-center ${pathname.startsWith('/profile') ? 'text-blue-500' : 'text-gray-500'}`}
        >
          <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
